...
<html>
    ...
    <body>
        ...
        <div id="show-students" class="content scaffold-show" role="main">
            ...
            <f:display bean="students" />
            <g:form resource="${this.students}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.students}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
